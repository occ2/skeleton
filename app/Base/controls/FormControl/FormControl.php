...
abstract class FormControl extends Control
{
    ...
    const SYMFONY_EVENT_PREFIX="form",
          SYMFONY_EVENT_DELIMITER=".";
     ...
     * @var string
     */
    public static $_symfonyEventClass='\occ2\FormControl\FormEvent';
    ...
    /**
     * enable access to form direct thu $control->form
     * @param string $name
     * @return $this
     */
    ...
    protected function setupSymfony(NForm $form)
    {
        if (!empty($this->_symfonyEvents)) {
            ...
            $s = static::SYMFONY_EVENT_PREFIX . static::SYMFONY_EVENT_DELIMITER . Strings::firstLower(ClassType::from(static::class)->shortName) . static::SYMFONY_EVENT_DELIMITER;
            $e = self::$_symfonyEventClass;
            $form->onError[] = function (NForm $form) use ($presenter,$s,$e) {
                $this->_eventDispatcher->dispatch($s . "error", new $e($form, $presenter, $s . "error"));
            };
            $form->onValidate[] = function (NForm $form) use ($presenter,$s,$e) {
                $this->_eventDispatcher->dispatch($s . "validate", new $e($form, $presenter, $s . "validate"));
            };
            $form->onSubmit[] = function (NForm $form) use ($presenter,$s,$e) {
                $this->_eventDispatcher->dispatch($s . "submit", new $e($form, $presenter, $s . "submit"));
            };
            $form->onSuccess[] = function (NForm $form) use ($presenter,$s,$e) {
                $this->_eventDispatcher->dispatch($s . "success", new $e($form, $presenter, $s . "success"));
            };
        }
        return;
    }
    ...
    /**
     * set form builder
     * @param \occ2\FormControl\IFormBuilder $builder
     * @return $this
     */
    ...
    /**
     * get form builder
     * @return \occ2\FormControl\IFormBuilder
     */
